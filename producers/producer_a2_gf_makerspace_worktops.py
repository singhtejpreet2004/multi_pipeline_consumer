#!/usr/bin/env python3
"""
Kafka Producer — a2_gf_makerspace_worktops (A2-MK)
Topic   : video.raw.a2_mk
RTSP    : rtsp://$RTSP_CAM_USER:$RTSP_CAM_PASS@10.1.34.54:554/cam/realmonitor?channel=1&subtype=1
...
RTSP_URL          = f"rtsp://{os.environ['RTSP_CAM_USER']}:{os.environ['RTSP_CAM_PASS']}@10.1.34.54:554/cam/realmonitor?channel=1&subtype=1"
KAFKA_BROKERS     = "10.1.40.43:9092,10.1.40.44:9093,10.1.40.45:9094"
TOPIC_NAME        = "video.raw.a2_mk"
WIDTH             = 640
HEIGHT            = 480
JPEG_QUALITY      = 95
