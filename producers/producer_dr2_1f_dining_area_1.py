#!/usr/bin/env python3
"""
Kafka Producer — dr2_1f_dining_area_1 (DR2-DA1)
Topic   : video.raw.dr2_da1
RTSP    : rtsp://$RTSP_CAM_USER:$RTSP_CAM_PASS@10.1.34.224:554/cam/realmonitor?channel=1&subtype=1
...
RTSP_URL          = f"rtsp://{os.environ['RTSP_CAM_USER']}:{os.environ['RTSP_CAM_PASS']}@10.1.34.224:554/cam/realmonitor?channel=1&subtype=1"
KAFKA_BROKERS     = "10.1.40.43:9092,10.1.40.44:9093,10.1.40.45:9094"
TOPIC_NAME        = "video.raw.dr2_da1"
WIDTH             = 640
HEIGHT            = 480
JPEG_QUALITY      = 95
